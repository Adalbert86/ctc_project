  ...
  render() {
    ...
    return (
		...
		<Grid>
			...
			Name: {this.state.customer.name}<br />
  	    ...
  	    {this.state.certificates.map(c =>
              <tr>
      			...
      			<td>
      				...
      				<span onClick={this.handleToggleBtnClick} ><ToggleCertificateButton cert={c} /></span>
      				&nbsp;
      				<span onClick={this.handleToggleBtnClick} ><CertificateDeleteButton cert={c} /></span>
...
<Link to={"/addcertificate/"+this.props.match.params.id} ><Button bsStyle="primary">Add new certificate</Button></Link>

<div onClick={this.handleDeleteeBtnClick} ><DeleteCustomerButton customerid={this.props.match.params.id} /></div>
